...
public class TestDescriptorParser extends FrameworkTestCase
{
    private void checkAttributes(Element e, String[] attributes)
    {
        ...
        for (int i = 0; i < count; i += 2)
        {
            ...
            assertEquals(
                "Attribute " + name + " of element " + e.getElementName(),
                value,
                map.get(name));
    ...
    public void testBadConfigurationId() throws Exception
    {
        ...
        assertLoggedMessagePattern(
            "Attribute id \\(foo\\.bar\\) of element module/configuration-point is improperly "
    ...
    public void testBadVersion() throws Exception
    {
        ...
        assertLoggedMessagePattern(
            "Attribute version \\(1\\.0\\.alpha\\) of element module is improperly "
